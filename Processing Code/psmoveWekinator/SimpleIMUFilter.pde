/// Simple IMU filter. Adapted from theory and code at http://starlino.com/imu_guide.html and http://www.starlino.com/imu_kalman_arduino.html
///
...
{	
  ...
  //  println("rwacc x: " + featArr[0] + " y: " + featArr[1] + " z: " + featArr[2]);
